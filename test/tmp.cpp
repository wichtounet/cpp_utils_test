...
TEST_CASE( "tmp/variadic_contains/1" ) {
...
TEST_CASE( "tmp/is_homogeneous/1" ) {
...
TEST_CASE( "tmp/is_sub_homogeneous/1" ) {
...
TEST_CASE( "tmp/is_specialization/1" ) {
...
TEST_CASE( "tmp/add_const_lvalue_t/1" ) {
...
TEST_CASE( "tmp/add_const_rvalue_t/1" ) {
...
TEST_CASE( "tmp/for_each_tuple_t/1" ) {
    test_op oo;
